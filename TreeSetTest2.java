...
class ChemicalElement implements Comparable<ChemicalElement>
{
	...
	float atomicWeight; 	//1.0293
	
	//k1.kiteFight(k2); 			element1.compareTo(element2)
/*	public int compareTo(ChemicalElement otherElement)
	...
	*/
	...
	@Override
	public int compareTo(ChemicalElement o) { // element1.compareTo(element2)
		System.out.println("Comparing "+atomicName+" with "+o.atomicName);
		return atomicName.compareTo(o.atomicName); //string class's method
	}
...
/*
 implements Comparable <ChemicalElement>
public int compareTo(ChemicalElement otherElement)
	{
		System.out.println("Comparing..."+atomicNumber+" with "+otherElement.atomicNumber);
		return Integer.compare(atomicNumber, otherElement.atomicNumber);
	...
	//The type ChemicalElement must implement the inherited abstract 
//method Comparable<ChemicalElement>.compareTo(ChemicalElement)
